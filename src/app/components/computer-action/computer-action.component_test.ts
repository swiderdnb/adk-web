...
describe('ComputerActionComponent', () => {
  ...
  describe('Screenshot Display', () => {
    it.autoTick('should format screenshot as data URI', () => {
    ...
    it.autoTick('should use default mimetype if missing', () => {
      component.functionResponse = {
        name: 'computer',
  ...
  describe('Coordinate Scaling', () => {
    it.autoTick('should calculate style percentage for coordinates', () => {
    ...
    it.autoTick('should match python normalization logic', () => {
      component.functionCall = {
        name: ComputerTool.COMPUTER,
  ...
  describe('Backward Screenshot Search', () => {
    it.autoTick('should find the last available screenshot in history (plural schema)', () => {
      component.index = 2;
      component.allMessages = [
        {
          functionResponses: [
    ...
    it.autoTick('should find screenshot in parts of functionResponses', () => {
      component.index = 1;
      component.allMessages = [
        {
          functionResponses: [
  ...
  describe('Fallback Display', () => {
    it.autoTick('should show fallback text when no screenshot is found', () => {
      component.index = 0;
      component.allMessages = [];
      component.functionCall = {
  ...
  describe('getAllComputerUseCoordinates', () => {
    it.autoTick('should associate coordinates with the previous image', () => {
      component.allMessages = [
        {
          functionResponses: [
            {name: 'computer', response: {image: {data: 'img1'}}}
