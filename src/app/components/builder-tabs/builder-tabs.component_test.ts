...
describe('BuilderTabsComponent - Callback Support', () => {
  ...
  describe('Callback Properties', () => {
    it.autoTick('should have callback-related properties', () => {
  ...
  describe('Callback Methods', () => {
    ...
    it.autoTick('should select callback correctly', () => {
      component.selectCallback(mockCallback);

      expect(component.editingCallback).toBe(mockCallback);
    });

    it.autoTick('should navigate back to callback list', () => {
    ...
    it.autoTick('should handle callback type change', () => {
  ...
  describe('Service Integration', () => {
    it.autoTick('should subscribe to selected callback changes', () => {
    ...
    it.autoTick('should subscribe to agent callback updates', () => {
  ...
  describe('Callback UI Behavior', () => {
    it.autoTick('should set selectedTabIndex to 3 when selecting a callback', () => {
      const mockCallback: CallbackNode = {
        name: 'test_callback',
        type: 'before_agent',
        code: 'def test_callback(ctx): pass',
    ...
    it.autoTick('should handle null callback selection', () => {
      fixture.detectChanges();
  ...
  describe('Callback Code Field', () => {
    it.autoTick('should initialize callback with empty code', () => {
      const mockCallback: CallbackNode = {
        name: 'new_callback',
        type: 'before_agent',
        code: '',
    ...
    it.autoTick('should preserve callback code when editing', () => {
      const customCode =
    ...
    it.autoTick('should handle callback with description', () => {
      const mockCallback: CallbackNode = {
  ...
  describe('Callback Type Validation', () => {
    it.autoTick('should have all ADK callback types available', () => {
      const expectedTypes = [
        'before_agent',
        'before_model',
        'before_tool',
  ...
  describe('Agent Config with Callbacks', () => {
    it.autoTick('should update agent callbacks when service emits update', () => {
    ...
    it.autoTick('should not update callbacks for different agent', () => {
      fixture.detectChanges();
      component.agentConfig = {
        name: 'current-agent',
        isRoot: false,
