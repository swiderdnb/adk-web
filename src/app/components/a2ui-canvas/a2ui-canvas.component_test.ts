...
describe('A2uiCanvasComponent', () => {
  ...
  it.autoTick('should process beginRendering message', () => {
    const message = {
      beginRendering: {
  ...
  it.autoTick('should process surfaceUpdate message', () => {
    const message = {
      surfaceUpdate: {
        surfaceId: 'sales_data_yearly_surface',
        components: [
  ...
  it.autoTick('should process dataModelUpdate message', () => {
    const message = {
      dataModelUpdate: {
        surfaceId: 'sales_data_yearly_surface',
        path: '/',
  ...
  it.autoTick('should update activeSurface when surfaceId matches', () => {
