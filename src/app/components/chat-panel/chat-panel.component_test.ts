...
describe('ChatPanelComponent', () => {
  ...
  describe('Message Handling', () => {
    it.autoTick('should emit sendMessage event on Enter in textarea', () => {
    ...
    it.autoTick('should display file preview and emit removeFile event', () => {
  ...
  xdescribe('Events', () => {
    it.autoTick('should emit clickEvent when bot icon is clicked', () => {
    ...
    it.autoTick('should disable bot icon when eventId is not set', () => {
  ...
  describe('Scrolling', () => {
    ...
    describe('when infinity scrolling is enabled', () => {
      ...
      it.autoTick('should lazy load messages when session name changes', () => {
      ...
      describe('when new messages are loaded', () => {
        ...
        it.autoTick('should restore scroll position', fakeAsync(() => {
                      component['onScroll'].next(
                          {target: scrollContainer} as unknown as Event);
                      tick();
  ...
  describe('disabled features', () => {
    it.autoTick('should have the attach_file button disabled', () => {
    ...
    it.autoTick('should have the more_vert button disabled', () => {
    ...
    it.autoTick('should have the mic button disabled', () => {
    ...
    it.autoTick('should have the videocam button disabled', () => {
      mockFeatureFlagService.isBidiStreamingEnabledResponse.next(false);
    ...
    describe('when canEditSession is false', () => {
      ...
      it.autoTick('should not render the chat input', () => {
        const textarea = fixture.debugElement.query(By.css('textarea'));
    ...
    describe('when canEditSession is true', () => {
      ...
      it.autoTick('should render the chat input', () => {
        const textarea = fixture.debugElement.query(By.css('textarea'));
    ...
    xdescribe('when more options button is hidden', () => {
      ...
      it.autoTick('should not show more options button', () => {
        const allButtons =
            fixture.debugElement.queryAll(By.css('button[mat-icon-button]'));
        const button = allButtons.find(
  ...
  describe('Loading state', () => {
    describe('when session is loading', () => {
      ...
      it.autoTick('should show loading spinner', () => {
        const spinner =
            fixture.debugElement.query(By.css('mat-progress-spinner'));
        expect(spinner).toBeTruthy();
      });

      it.autoTick('should not show chat content', () => {
        const chatMessages =
    ...
    describe('when session is not loading', () => {
      ...
      it.autoTick('should show chat content', () => {
        const spinner =
            fixture.debugElement.query(By.css('mat-progress-spinner'));
        const chatMessages =
            fixture.debugElement.query(By.css('.chat-messages'));
  ...
  describe('Feedback UI', () => {
    ...
    it.autoTick('should hide when feature flag is off', () => {
      component.uiEvents = [new UiEvent({role: 'bot', text: 'message', event: {} as any})];
    ...
    it.autoTick('should hide when agent response is loading', () => {
      component.uiEvents = [new UiEvent({role: 'bot', text: 'message', event: {} as any})];
