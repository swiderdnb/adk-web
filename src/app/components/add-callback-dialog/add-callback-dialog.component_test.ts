...
describe('AddCallbackDialogComponent', () => {
  ...
  it.autoTick('should disable create button when callback name is empty', () => {
    component.callbackName = '';
    expect(component.createDisabled()).toBe(true);
  });

  it.autoTick('should enable create button when callback name is provided', () => {
    component.callbackName = 'test_callback';
    expect(component.createDisabled()).toBe(false);
  });

  it.autoTick('should close dialog with callback data when addCallback is called', () => {
    component.callbackName = 'test_callback';
  ...
  it.autoTick('should allow editing existing callback without flagging duplicate name', () => {
  ...
  it.autoTick('should not close dialog when callback name is empty', () => {
    component.callbackName = '';
  ...
  it.autoTick('should close dialog without data when cancel is called', () => {
    component.cancel();
