...
describe('FeatureFlagService', () => {
  ...
  describe('isImportSessionEnabled', () => {
    it.autoTick('should return true if \'import_session\' query param is \'true\'',
       async () => {
    ...
    it.autoTick('should return true (always enabled in this implementation)',
       async () => {
  ...
  describe('isEditFunctionArgsEnabled', () => {
    it.autoTick('should return true if \'edit_function_args\' query param is \'true\'',
       async () => {
    ...
    it.autoTick('should return false if \'edit_function_args\' query param is not \'true\'',
       async () => {
         activatedRoute.queryParams.next({});
         const isEnabled = await firstValueFrom(
             service.isEditFunctionArgsEnabled(),
  ...
  describe('isSessionUrlEnabled', () => {
    it.autoTick('should return true', async () => {
  ...
  describe('isA2ACardEnabled', () => {
    it.autoTick('should return true if \'a2a_card\' query param is \'true\'',
       async () => {
    ...
    it.autoTick('should return false if \'a2a_card\' query param is not \'true\'',
       async () => {
         activatedRoute.queryParams.next({});
         const isEnabled = await firstValueFrom(service.isA2ACardEnabled());
         expect(isEnabled).toBeFalse();
  ...
  describe('isNewSessionButtonEnabled', () => {
    it.autoTick('should return true by default', async () => {
      const isEnabled =
