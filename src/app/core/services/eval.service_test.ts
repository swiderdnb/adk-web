...
describe('EvalService', () => {
  ...
  describe('getEvalSets', () => {
    it.autoTick('should call GET /apps/{appName}/eval_sets', () => {
    ...
    it.autoTick('should return empty observable if no api domain', async () => {
  ...
  describe('createNewEvalSet', () => {
    it.autoTick('should call POST /apps/{appName}/eval-sets with correct body', () => {
  ...
  describe('listEvalCases', () => {
    it.autoTick('should call GET /apps/{appName}/eval_sets/{evalSetId}/evals', () => {
  ...
  describe('addCurrentSession', () => {
    it.autoTick('should call POST /apps/{appName}/eval_sets/{evalSetId}/add_session with correct body',
       () => {
         service
             .addCurrentSession(
  ...
  describe('runEval', () => {
    it.autoTick('should call POST /apps/{appName}/eval_sets/{evalSetId}/run_eval with correct body',
       () => {
  ...
  describe('listEvalResults', () => {
    it.autoTick('should call GET /apps/{appName}/eval_results', () => {
  ...
  describe('getEvalResult', () => {
    it.autoTick('should call GET /apps/{appName}/eval_results/{evalResultId}', () => {
  ...
  describe('getEvalCase', () => {
    it.autoTick('should call GET /apps/{appName}/eval_sets/{evalSetId}/evals/{evalCaseId}',
       () => {
  ...
  describe('updateEvalCase', () => {
    it.autoTick('should call PUT /apps/{appName}/eval_sets/{evalSetId}/evals/{evalCaseId} with correct body',
       () => {
  ...
  describe('deleteEvalCase', () => {
    it.autoTick('should call DELETE /apps/{appName}/eval_sets/{evalSetId}/evals/{evalCaseId}',
       () => {
