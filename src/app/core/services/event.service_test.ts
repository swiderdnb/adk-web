...
describe('EventService', () => {
  ...
  describe('getEventTrace', () => {
    it.autoTick('should call GET /debug/trace/{id}', () => {
  ...
  describe('getTrace', () => {
    it.autoTick('should call GET /debug/trace/session/{sessionId}', () => {
  ...
  describe('getEvent', () => {
    it.autoTick('should call GET /apps/{appName}/users/{userId}/sessions/{sessionId}/events/{eventId}/graph',
       () => {
