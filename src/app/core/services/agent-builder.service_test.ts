...
describe('AgentBuilderService - Callback Management', () => {
  ...
  describe('addCallback', () => {
    it.autoTick('should add a callback to an agent', () => {
    ...
    it.autoTick('should handle adding callbacks to non-existent agent', () => {
      const callback: CallbackNode = {
        name: 'test_callback',
        type: 'before_agent',
        code: 'def test_callback(callback_context): return None',
    ...
    it.autoTick('should initialize callbacks array if undefined', () => {
    ...
    it.autoTick('should emit callback update', () => {
    ...
    it.autoTick('should reject duplicate callback names', () => {
  ...
  describe('deleteCallback', () => {
    ...
    it.autoTick('should delete a callback from an agent', () => {
    ...
    it.autoTick('should handle deleting from non-existent agent', () => {
      expect(() =>
        service.deleteCallback('non-existent', callback)
      ).not.toThrow();
    });

    it.autoTick('should emit callback update after deletion', () => {
      spyOn(service['agentCallbacksSubject'], 'next');
    ...
    it.autoTick('should clear selected callback if deleted', async () => {
  ...
  describe('callback selection', () => {
    it.autoTick('should get and set selected callback', async () => {
      const callback: CallbackNode = {
        name: 'test_callback',
        type: 'before_agent',
        code: 'def test_callback(callback_context): return None',
    ...
    it.autoTick('should clear selected callback', async () => {
      const callback: CallbackNode = {
        name: 'test_callback',
        type: 'before_agent',
        code: 'def test_callback(callback_context): return None',
  ...
  describe('getAgentCallbacks', () => {
    it.autoTick('should emit callback updates', async () => {
      const callback: CallbackNode = {
        name: 'test_callback',
        type: 'before_agent',
        code: 'def test_callback(callback_context): return None',
  ...
  describe('setAgentCallbacks', () => {
    it.autoTick('should set callbacks with agent name and callbacks', async () => {
    ...
    it.autoTick('should clear callbacks when called without parameters', async () => {
