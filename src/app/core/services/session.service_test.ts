...
describe('SessionService', () => {
  ...
  describe('createSession', () => {
    it.autoTick('should call POST /apps/{appName}/users/{userId}/sessions with null body',
       () => {
  ...
  describe('listSessions', () => {
    it.autoTick('should call GET /apps/{appName}/users/{userId}/sessions', () => {
  ...
  describe('deleteSession', () => {
    it.autoTick('should call DELETE /apps/{appName}/users/{userId}/sessions/{sessionId}',
       () => {
  ...
  describe('getSession', () => {
    it.autoTick('should call GET /apps/{appName}/users/{userId}/sessions/{sessionId}',
       () => {
  ...
  describe('importSession', () => {
    it.autoTick('should call POST /apps/{appName}/users/{userId}/sessions with correct body',
       () => {
