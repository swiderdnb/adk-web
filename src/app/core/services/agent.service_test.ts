...
describe('AgentService', () => {
  ...
  it.autoTick('should be created', async () => {
    expect(service).toBeTruthy();
  });

  describe('App', () => {
    it.autoTick('should set the current app name', async () => {
      service.setApp(TEST_APP_NAME);
      const app = await firstValueFrom(service.getApp());
      expect(app).toBe(TEST_APP_NAME);
    });

    it.autoTick('should return an observable with the current app name', async () => {
  ...
  describe('LoadingState', () => {
    it.autoTick('should return loading state behavior subject', async () => {
      expect(service.getLoadingState().value).toBeFalse();
    });
  });

  describe('listApps', () => {
    it.autoTick('should call list-apps endpoint with correct url', async () => {
    ...
    it.autoTick('should return list of apps from http get', async () => {
    ...
    it.autoTick('should return an empty observable if apiServerDomain is not set',
       async () => {
  ...
  describe('runSse', () => {
    it.autoTick('should set loading state to true when called', async () => {
    ...
    it.autoTick('should make a POST request to /run_sse with correct arguments', async () => {
      spyOn(window, 'fetch').and.resolveTo(new Response());
      service.runSse(RUN_SSE_PAYLOAD).subscribe();
      expect(window.fetch)
    ...
    it.autoTick('should emit error if fetch fails', async () => {
    ...
    it.autoTick('should handle incomplete JSON chunks', async () => {
