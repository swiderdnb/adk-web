...
describe('UiStateService', () => {
  ...
  it.autoTick('should be instantiated', () => {
    expect(state.service).toBeTruthy();
  });

  describe('isSessionLoading', () => {
    it.autoTick('should return true when loading and feature flag is enabled', async () => {
      state.service.setIsSessionLoading(true);
      await expectAsync(firstValueFrom(state.service.isSessionLoading()))
        .toBeResolvedTo(true);
    });

    it.autoTick('should return false when not loading and feature flag is enabled', async () => {
      state.service.setIsSessionLoading(false);
      await expectAsync(firstValueFrom(state.service.isSessionLoading()))
        .toBeResolvedTo(false);
    });

    it.autoTick('should return false when loading and feature flag is disabled', async () => {
