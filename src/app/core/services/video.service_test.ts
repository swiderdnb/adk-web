...
import {beforeEach, describe, expect, flush, it, tick,} from 'google3/javascript/angular2/testing/catalyst/fake_async';

import {fakeAsync, initTestBed,} from '../../testing/utils.google';
...
describe('VideoService', () => {
  ...
  describe('createVideoElement', () => {
    it.autoTick('should create a video element with attributes', () => {
    ...
    it.autoTick('should append video element to container', () => {
      service.createVideoElement(container);
    ...
    it.autoTick('should clear existing video element if any', () => {
  ...
  describe('startRecording', () => {
    it.autoTick('should call createVideoElement', async () => {
    ...
    it.autoTick('should request video media', async () => {
      await service.startRecording(container);
    ...
    it.autoTick('should create and start MediaRecorder', async () => {
      await service.startRecording(container);
  ...
  describe('stopRecording', () => {
    it.autoTick('should stop media recorder', async () => {
      await service.startRecording(container);
      service.stopRecording(container);
      expect(mockMediaRecorder.stop).toHaveBeenCalled();
    });

    it.autoTick('should stop media stream tracks', async () => {
      await service.startRecording(container);
      service.stopRecording(container);
      expect(mockTrack.stop).toHaveBeenCalled();
    });

    it.autoTick('should clear video element', async () => {
      await service.startRecording(container);
      spyOn(container.nativeElement, 'querySelector')
          .and.returnValue(
              mockVideoElement,
