...
describe('ArtifactService', () => {
  ...
  describe('getLatestArtifact', () => {
    it.autoTick('should call the correct endpoint to get latest artifact', () => {
    ...
    it.autoTick('should return artifact data from http get', async () => {
  ...
  describe('getArtifactVersion', () => {
    it.autoTick('should call the correct endpoint to get artifact version', () => {
      service
          .getArtifactVersion(
