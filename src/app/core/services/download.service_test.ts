...
describe('DownloadService', () => {
  ...
  describe('downloadBase64Data', () => {
    ...
    it.autoTick('should set download attribute to filename', () => {
      service.downloadBase64Data(base64Data, mimeType, FILE_NAME_PNG);
      expect(mockAnchor.download).toBe(FILE_NAME_PNG);
    });

    it.autoTick('should append anchor to body', () => {
      service.downloadBase64Data(base64Data, mimeType, FILE_NAME_PNG);
      expect(appendChildSpy).toHaveBeenCalledWith(mockAnchor);
    });

    it.autoTick('should click anchor', () => {
      service.downloadBase64Data(base64Data, mimeType, FILE_NAME_PNG);
      expect(mockAnchor.click).toHaveBeenCalled();
    });

    it.autoTick('should remove anchor from body', () => {
      service.downloadBase64Data(base64Data, mimeType, FILE_NAME_PNG);
  ...
  describe('downloadObjectAsJson', () => {
    ...
    it.autoTick('should call safeValuesService.createObjectUrl with blob', () => {
      service.downloadObjectAsJson(data, FILE_NAME_JSON);
    ...
    it.autoTick('should call safeValuesService.setAnchorHref with object url', () => {
      service.downloadObjectAsJson(data, FILE_NAME_JSON);
      expect(safeValuesService.setAnchorHref)
          .toHaveBeenCalledWith(
              mockAnchor,
    ...
    it.autoTick('should revoke object URL', () => {
      service.downloadObjectAsJson(data, FILE_NAME_JSON);
