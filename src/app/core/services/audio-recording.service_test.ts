...
describe('AudioRecordingService', () => {
  ...
  describe('startRecording', () => {
    it.autoTick('should request user media', async () => {
    ...
    it.autoTick('should create AudioContext', async () => {
      await service.startRecording();
      expect(window.AudioContext).toHaveBeenCalled();
    });

    it.autoTick('should add audio worklet module', async () => {
      await service.startRecording();
    ...
    it.autoTick('should create media stream source', async () => {
      await service.startRecording();
    ...
    it.autoTick('should create AudioWorkletNode', async () => {
      await service.startRecording();
    ...
    it.autoTick('should connect audio nodes', async () => {
      await service.startRecording();
  ...
  describe('stopRecording', () => {
    ...
    it.autoTick('should disconnect audio source', async () => {
      await service.startRecording();
      service.stopRecording();
      expect(mockSource.disconnect).toHaveBeenCalled();
    });

    it.autoTick('should close audio context', async () => {
      await service.startRecording();
      service.stopRecording();
