...
describe('ComputerUse', () => {
  describe('isVisibleComputerUseClick', () => {
    it.autoTick('should return true for valid computer tool with coordinate array', () => {
      const call = {
    ...
    it.autoTick('should return false for computer tool without coordinates', () => {
      const call = {
        name: ComputerTool.COMPUTER,
        args: {
          action: ComputerAction.LEFT_CLICK
    ...
    it.autoTick('should return true for specialized tool with x and y args', () => {
      const call = {
    ...
    it.autoTick('should return true for hover tool with coordinate array', () => {
      const call = {
    ...
    it.autoTick('should return true for scroll document tool without coordinates', () => {
      const call = {
    ...
    it.autoTick('should return false for non-visual actions in computer tool', () => {
      const call = {
        name: ComputerTool.COMPUTER,
        args: {
    ...
    it.autoTick('should return false when functionCall is missing (undefined)', () => {
      expect(isVisibleComputerUseClick(undefined)).toBeFalse();
    });
  });

  describe('isComputerUseResponse', () => {
    it.autoTick('should return true for valid response with image data', () => {
      const response: any = {
        name: 'computer',
        response: {
          image: {
    ...
    it.autoTick('should return false when image data is missing', () => {
      const response: any = {
        name: 'computer',
        response: {
    ...
    it.autoTick('should return false when functionResponse is missing (undefined)', () => {
