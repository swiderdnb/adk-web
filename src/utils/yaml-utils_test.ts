...
describe('YamlUtils - Callback Support', () => {
  ...
  describe('buildCallbacksConfig', () => {
    it.autoTick('should build callbacks configuration grouped by type', () => {
    ...
    it.autoTick('should return empty object for undefined callbacks', () => {
      const config = YamlUtils.buildCallbacksConfig(undefined);
      expect(config).toEqual({});
    });

    it.autoTick('should return empty object for empty callbacks array', () => {
  ...
  describe('generateYamlFile', () => {
    it.autoTick('should generate YAML file with callbacks when agent has callbacks', () => {
    ...
    it.autoTick('should not include callbacks in YAML when agent has no callbacks', () => {
    ...
    it.autoTick('should handle empty callbacks array', () => {
